rule star_align:
    input:
        fq1 = [f"results/bcl2fq/{runid}/{{sample}}_L001_R1_001.fastq.gz", f"results/bcl2fq/{runid}/{{sample}}_L002_R1_001.fastq.gz"], 
        fq2 = [f"results/bcl2fq/{runid}/{{sample}}_L001_R2_001.fastq.gz", f"results/bcl2fq/{runid}/{{sample}}_L002_R2_001.fastq.gz"], 
